          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl leading-relaxed">
                Raviro is dedicated to bridging the gap between public health
                research and real-world impact in developing regions. We believe
                in the power of knowledge sharing and collaborative solutions to
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="p-6 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-gray-600">
                    We believe in making research accessible and actionable for
                ...
                <div className="p-6 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-gray-600">
                    We foster partnerships that bridge research institutions
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Interested in collaborating or learning more about our work? We'd
