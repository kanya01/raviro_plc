...
describe("Footer", () => {
  ...
  describe("Content Sections", () => {
    it("renders company section with correct content", () => {
      ...
      expect(
        screen.getByText(/Bridging the gap between public health research/i),
      ).toBeInTheDocument();
    });
  ...
  describe("Social Links", () => {
    it("renders social media links with correct attributes", () => {
      ...
      const bottomSection =
        screen.getByText(/© \d{4} Raviro/).parentElement.parentElement;
  ...
  describe("Dynamic Content", () => {
    it("displays current year in copyright text", () => {
      ...
      expect(
        screen.getByText(new RegExp(`© ${currentYear} Raviro`)),
      ).toBeInTheDocument();
    });
  });
