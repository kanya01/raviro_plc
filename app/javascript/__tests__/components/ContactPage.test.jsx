...
describe("ContactPage", () => {
  ...
  describe("Form Submission", () => {
    it("handles successful submission", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/thank you for submitting your query/i),
        ).toBeInTheDocument();
      });
    ...
    test.skip("handles submission errors", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/failed to submit inquiry/i),
        ).toBeInTheDocument();
      });
    });
  ...
  describe("Success Modal", () => {
    it("closes modal on outside click", async () => {
      ...
      // Click outside modal
      fireEvent.click(
        screen.getByText(/click outside to dismiss/i).parentElement
          .parentElement,
      );
      ...
      await waitFor(() => {
        expect(
          screen.queryByText(/thank you for submitting your query/i),
  ...
  describe("Accessibility", () => {
    it("has proper form labeling", () => {
      ...
      expect(screen.getByLabelText(/inquiry/i)).toHaveAttribute(
        "id",
        "inquiry",
      );
    });
